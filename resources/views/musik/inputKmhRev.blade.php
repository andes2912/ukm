@extends('musik.template')
    ...
    @section('isi')
        ...
        <div class="col-md-8">
            <article class="widget widget__form">
                <header class="widget__header">
                    <div class="widget__title">
                        <i class="pe-7s-menu"></i><h3>Kirim Proposal Untuk KMH</h3>
                    </div>
            ...
            <form action="{{ route('proposalmusik.store', $inputKmhRev->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" value=" {{$inputKmhRev->title}} " class="stacked-input" id="input-1" placeholder="Judul Proposal" required>
                   ...
                   <label for="input-1" class="stacked-label">
                    ...
                    <input type="text" class="stacked-input" id="input-1" placeholder="Ditujukan Untuk" disabled>
                        <select class="btn btn-block white dropdown-toggle" type="button" name="user">
                            <option value="KMH">Biro Kemahasiswaan & Pemasaran</option>
                        </select>
