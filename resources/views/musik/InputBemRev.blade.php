@extends('musik.template')
	...
	<div class="col-md-12">
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('proposalmusik.store', $InputRevBem->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" class="stacked-input" value=" {{$InputRevBem->title}} " id="input-1" placeholder="Judul Proposal">                   
                    ...
                    <label class="full-label">
                        <input type="file" name="file" id="file-att" value=" {{$InputRevBem->file}} ">
