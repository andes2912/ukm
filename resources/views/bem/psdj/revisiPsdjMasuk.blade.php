			...
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title">
						...
						<a href=" {{route('bem.psdj.revisiKeluarPsdj')}} " class="btn blue">Lihat Revisi Keluar</a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href="{{ route('downloadPsdj.download', $revisimasuk->id) }}" class="btn red"> <span>Lihat</span></a>
							</td>
						</div>
