@extends('bem.template')
    ...
    @section('isi')
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('validasipsdj.store') }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" value="{{$BemPsdjEdit->title}}" class="stacked-input" id="input-1" placeholder="Judul Proposal" required>
