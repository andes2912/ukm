				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							<td>										
									<div class="post_info ">
										<h3>{{ $pengajuanmusik->id }}</h3>													
									</div>
							
							</td>
							<td>
								<p class="post__info">{{ $pengajuanmusik->title }}</p>
							</td>
							<td>
								<p class="post__date">{{ $pengajuanmusik->created_at }}</p>
							</td>
							<td>
								<p class="post_date"> {{ $pengajuanmusik->user }} </p>
							</td>
							<td>
							...
							<div class="dropdown">
							<td>	
								<a href="{{ route('DownloadMusikIn.download', $pengajuanmusik->id) }}" class="btn red"> <span>Lihat</span></a>
						</div>
