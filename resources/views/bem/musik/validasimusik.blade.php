    ...
    @section('isi')
		...
		<div class="row">
			...
			<div class="tabs__content--3">
				...
				<div class="media message fav">BemMusikDelay
					<figure class="pull-left rounded-image message__img">
						<img class="media-object" src="{{ asset('asset/img/user1.jpg')}}" alt="user">
					</figure>
					<div class="media-body">
				...
				<div class="members__container">									
					<div class="media message checked">
						<div class="media-body"> @foreach( $BemMusikRev as $BemMusikRev )
							...
							<p class="message__location"> <i class="pe-7s-clock"></i> {{$BemMusikRev->created_at}} | {{$BemMusikRev->created_at->diffForHumans()}} </p> <hr> <hr> <br>
							@endforeach
						</div>
