	...
	@section('header')
		<div class="main-header__nav">
					<h1 class="main-header__title">
						...
						<span>Halaman Validasi Proposal UKM Musik</span>
					</h1>
    ...
    @section('isi')
		...
		<div class="row">
				...
				<article class="widget">
					...
					<div class="media message">
						...
						<div class="media-body">
							<h4 class="media-heading message__heading"> {{$BemMusikAcc->title}}</h4> <hr>
							<p class="message__msg"><span> Tanggal : {{ $BemMusikAcc->created_at }} </span></p>
			...
			<div class="tabs__content--2">
				@foreach($BemMusikMasuk as $BemMusikMasuk)
				<div class="media message">
					{{-- <figure class="pull-left rounded-image message__img">
						<img class="media-object" src="{{asset('asset/img/user1.jpg')}}" alt="user">				
					</figure> --}}
			...
			<div class="tabs__content--3">
				...
				<div class="media message">BemMusikDelay
					<div class="media-body">
						...
						<div class="message__controls--cont">
							<ul class="message__controls">
								<li><a href=" {{route('bem.musik.updateMusik', $BemMusikDelay->id)}} " onclick="return true;"><i class="pe-7f-back pe-rotate-180"></i> <span>Ubah Status</span></a></li>
			...
			<div class="widget__content">
				...
				<div class="members__container">									
					<div class="media message checked">
						<div class="media-body"> @foreach( $BemMusikRev as $BemMusikRev )
							<h3> {{$BemMusikRev->title}} </h3> <br>
							<p class="message__location"> <i class="pe-7s-clock"></i> {{$BemMusikRev->updated_at}} | {{$BemMusikRev->updated_at->diffForHumans()}} </p> <hr> <hr> <br>
							@endforeach
						</div>
