@extends('bem.template')
			...
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title">
						...
						<a href=" {{route('bem.dcfc.approveDcfc')}} " class="btn blue btn-primary">Detail</a>
					</div>
					<div class="widget__config">
						<a href="#"><i class="pe-7f-refresh"></i></a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href="{{ route('unduhBemDcfcOut.download', $ArsipAcc->id) }}" class="btn red"> <span>Lihat</span></a>			
							</td>
						</div>
	...
	<div class="col-md-12">
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title ">
						<i class="pe-7s-menu"></i><h3>Daftar Arsip Proposal UKM Dcfc [ Direvisi ]</h3>
						<a href=" {{route('bem.dcfc.revisiDcfcMasuk')}} " class="btn blue btn-primary">Detail</a>
					</div>
					<div class="widget__config">
						<a href="#"><i class="pe-7f-refresh"></i></a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href="{{ route('unduhBemDcfcOut.download', $ArsipRev->id) }}" class="btn red"> <span>Lihat</span></a>
							</td>
						</div>
			...
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title ">
						...
						<a href=" {{route('bem.dcfc.menunggu')}} " class="btn blue btn-primary">Detail</a>
					</div>
					<div class="widget__config">
						<a href="#"><i class="pe-7f-refresh"></i></a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href="{{ route('unduhBemDcfcOut.download', $ArsipDelay->id) }}" class="btn red"> <span>Lihat</span></a>
							</td>
						</div>
