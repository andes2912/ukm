		...
		<article class="widget">
			<header class="widget__header one-btn">
				<div class="widget__title">
					<i class="pe-7s-menu"></i><h3>Daftar Proposal UKM Psdj [ Pengajuan ]</h3>
			...
			<div class="widget__content table-responsive">
				...
				<tbody>
					...
					<tr class="spacer">
						...
						<td>
							<p class="post_info"> {{$pengajuanPsdj->id}} </p>
						</td>
						<td>
							<p >{{ $pengajuanPsdj->title }}</p>
						...
						<div class="dropdown">
							<td>
								<a href="{{ route('DownloadKmhPsdj.download', $pengajuanPsdj->id) }}" class="btn red">Lihat</a>								
							</td>
						</div>
					</tr>
						@endforeach
