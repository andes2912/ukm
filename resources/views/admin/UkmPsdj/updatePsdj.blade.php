@extends('admin.template')
	...
	@section('header')
		<div class="main-header__nav">
					<h1 class="main-header__title">
						...
						<span>Halaman Update Proposal UKM Psdj</span>
					</h1>
    ...
    @section('isi')
        ...
        <div class="col-md-8">
            <article class="widget widget__form">
                <header class="widget__header">
                    <div class="widget__title">
                        <i class="pe-7s-menu"></i><h3>Kirim Proposal Untuk Psdj</h3>
                    </div>
            ...
            <form action="{{ route('validasikmhPsdj.update', $UpdatePsdj->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" value="{{$UpdatePsdj->title}}" class="stacked-input" id="input-1" placeholder="Judul Proposal" required>
