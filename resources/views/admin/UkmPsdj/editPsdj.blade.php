@extends('admin.template')
	...
	<div class="col-md-12">
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('validasikmhPsdj.store', $editPsdj->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" class="stacked-input" value=" {{$editPsdj->title}} " id="input-1" placeholder="Judul Proposal">                   
