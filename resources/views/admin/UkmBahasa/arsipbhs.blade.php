@extends('admin.template')
						...
						<div class="dropdown">
							<td>
								...
								<ul class="dropdown-menu">
									<li><a href="{{ route('validasi.download', $disetujui->id) }}">Lihat</a></li>									
	...
	<div class="col-md-12">
		<article class="widget">
			<header class="widget__header one-btn">
				<div class="widget__title">
					<i class="pe-7s-menu"></i><h3>Daftar Arsip Proposal UKM Bahasa [ Revisi ]</h3>
					...
					<tr class="spacer">
						...
						<div class="dropdown">
							<td>
								...
								<ul class="dropdown-menu">
									<li><a href="{{ route('bahasa.unduh', $direvisi->id) }}">Lihat</a></li>									
