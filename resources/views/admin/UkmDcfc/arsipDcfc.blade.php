		...
		<article class="widget">
			<header class="widget__header one-btn">
				<div class="widget__title">
					...
					<a href="{{route('admin.UkmDcfc.disetujui')}}" button class="btn blue">Detail</a> 
				</div>
				<div class="widget__config">
		...
		<article class="widget">
			<header class="widget__header one-btn">
				<div class="widget__title">
					...
					<a href="{{route('admin.UkmDcfc.revisiKeluar')}}" button class="btn blue">Detail</a> 
				</div>
				<div class="widget__config">
					<a href="{{ url('admin') }}"><i class="pe-7s-back"></i></a>
				</div>
					...
					<tr class="spacer">
						...
						<div class="dropdown">
							<td>
								...
								<ul class="dropdown-menu">
									<li><a href="{{ route('DownloadKmhDcfc.download', $direvisi->id) }}">Lihat</a></li>									
		...
		<article class="widget">
			<header class="widget__header one-btn">
				<div class="widget__title">
					...
					<a href="{{route('admin.UkmDcfc.menunggu')}}" button class="btn blue">Detail</a> 
				</div>
				<div class="widget__config">
					<a href="{{ url('admin') }}"><i class="pe-7s-back"></i></a>
				</div>
					...
					<tr class="spacer">
						...
						<div class="dropdown">
							<td>
								...
								<ul class="dropdown-menu">
									<li><a href="{{ route('DownloadKmhDcfc.download', $menunggu->id) }}">Lihat</a></li>									
