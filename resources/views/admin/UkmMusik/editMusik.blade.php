        ...
        <div class="col-md-8">
            <article class="widget widget__form">
                <header class="widget__header">
                    ...
                    <a href="{{route('validasikmhMusik.index')}}" class="btn blue">Lihat Validasi</a>
                    </div>
                    <div class="widget__config">
                        <a href="#"><i class="pe-7f-refresh"></i></a>
            ...
            <form action="{{ route('validasikmhMusik.store', $EditMusik->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" class="stacked-input" value=" {{$EditMusik->title}} " id="input-1" placeholder="Judul Proposal">                   
