@extends('admin.template')
	...
	@section('header')
		<div class="main-header__nav">
					<h1 class="main-header__title">
						...
						<span>Halaman Update Proposal UKM Musik</span>
					</h1>
    ...
    @section('isi')
        ...
        <div class="col-md-8">
            <article class="widget widget__form">
                <header class="widget__header">
                    <div class="widget__title">
                        <i class="pe-7s-menu"></i><h3>Kirim Proposal Untuk Musik</h3>
                    </div>
            ...
            <form action="{{ route('validasikmhMusik.update', $UpdateMusik->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" value="{{$UpdateMusik->title}}" class="stacked-input" id="input-1" placeholder="Judul Proposal" required>
