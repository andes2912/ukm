@extends('bahasa.template')
    ...
    @section('isi')
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('proposal.store', $InputValidasiBemAcc->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" value=" {{$InputValidasiBemAcc->title}} " class="stacked-input" id="input-1" placeholder="Judul Proposal" required>
