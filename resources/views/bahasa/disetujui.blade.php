	...
	@section('isi')
			...
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title">
						...
						<a href=" {{route('bahasa.disetujuiBem')}} " class="btn blue btn-primary">Detail</a>
					</div>
					<div class="widget__config">
						<a href="#"><i class="pe-7f-refresh"></i></a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href=" {{route('unduhvalidasi.download', $disetujuiBem->id)}} " class="btn blue" >Lihat</a>
							</td>
						</div>
        ...
        <div class="col-md-12">
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title">
						<i class="pe-7s-menu"></i><h3>Daftar Arsip Proposal Disetujui UKM Bahasa [ KMH ]</h3>
						<a href=" {{route('bahasa.disetujuiKmh')}} " class="btn blue btn-primary">Detail</a>
					</div>
					<div class="widget__config">
						<a href="#"><i class="pe-7f-refresh"></i></a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href=" {{route('unduhvalidasi.download', $disetujuiKmh->id)}} " class="btn blue" >Lihat</a>
							</td>
						</div>
