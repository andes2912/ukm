        ...
        <div class="row">
					...
					<div class="media message">
						...
						<div class="message__controls--cont">
							<ul class="message__controls">
								...
								<li><a href=" {{ route('bahasa.inputKmh', $InputValidasiBemAcc->id)}} " onclick="return true;" title="Kirim ke Kemahasiswaan" ><i class="pe-7s-back"></i><span>Kirim</span></a></li>
								<li><a href=" {{ route('unduhBem.download', $InputValidasiBemAcc->id) }}" title="Download file {{ $InputValidasiBemAcc->title }}" onclick="return true;"><i class="pe-7f-back pe-rotate-180"></i> <span>Cetak</span></a></li>
			...
			<div class="tabs__content--2">
				...
				<div class="media message">
					...
					<div class="media-body">
						<h4 class="media-heading message__heading">{{$InputValidasiBemRev->title}}</h4> <span style="color:coral;">{{ $InputValidasiBemRev->updated_at->diffForHumans() }}</span><hr>
						<p class="message__msg"><span style="color:dodgerblue">Pengirim : BEM </span> | <span style="color:darkorange; font:bold;"> Tanggal :{{ $InputValidasiBemRev->updated_at}} </span></p>
						<input type="checkbox" class="msg-o" id="msg-o4" checked>
						<div class="message__controls--cont">
							<ul class="message__controls">
								<li><a href="{{route('proposal.edit',$InputValidasiBemRev->id)}}" onclick="return true;"><i class="pe-7f-back pe-rotate-180"></i> <span>Revisi</span></a></li>
								<li><a href="{{ route('unduhBem.download', $InputValidasiBemRev->id) }}" class="set_fav" onclick="return true;"><i class="pe-7f-back"></i> <span>Lihat</span></a></li>
	...
	<div class="col-md-6">
		<article class="widget">
			...
			<div class="widget__content">
				...
				<div class="clearfix"></div>
				<div class="members__footer"> <a href="{{route('bahasa.arsip')}}"><button class="members__load-more"> Index pengajuan</button></a><a href=" {{route('bahasa.revisiBhs')}} "><button class="members__search"> Index Revisi
					</button></a>
				</div>
			</div>
		</article><!-- /widget -->
