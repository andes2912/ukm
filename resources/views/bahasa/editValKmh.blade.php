@extends('bahasa.template')
	...
	<div class="col-md-12">
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('proposal.store', $EditBhsValKmh->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" class="stacked-input" value=" {{$EditBhsValKmh->title}} " id="input-1" placeholder="Judul Proposal">                   
                    ...
                    <input type="text" class="stacked-input" id="input-1" placeholder="Ditujukan Untuk" disabled>
                        <select class="btn btn-block white dropdown-toggle" type="button" name="user">
                            <option value="KMH">Badan Eksekutif Mahasiswa</option>
                        </select>
                    
                    <label class="full-label">
                        <input type="file" name="file" id="file-att" value=" {{$EditBhsValKmh->file}} ">
