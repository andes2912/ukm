@extends('psdj.template')
	...
	@section('header')
		<div class="main-header__nav">
					<h1 class="main-header__title">
						...
						<span>Halaman Input Proposal UKM Psdj</span>
					</h1>
    ...
    @section('isi')
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('proposalpsdj.store', $inputKmhRev->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" class="stacked-input" value=" {{$inputKmhRev->title}} " id="input-1" placeholder="Judul Proposal" required>
