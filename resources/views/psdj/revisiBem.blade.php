			...
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title">
						<i class="pe-7s-menu"></i><h3>Daftar Arsip Revisi Proposal UKM Psdj [ BEM ]</h3>
					</div>
					<div class="widget__config">
						<a href="Kembali" onclick="window.location.href=' {{route('psdj.arsip')}} '" ><i class="pe-7f-back"></i></a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href=" {{route('unduhPsdj.download', $revisibem->id)}} " class="btn blue" >Lihat</a>
							</td>
						</div>
