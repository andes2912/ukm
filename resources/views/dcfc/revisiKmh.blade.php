			...
			<article class="widget">
				<header class="widget__header one-btn">
					<div class="widget__title">
						<i class="pe-7s-menu"></i><h3>Daftar Arsip Revisi Proposal UKM Dcfc [ KMH ]</h3>
						<a href=" {{route('dcfc.revisiBem')}}" class="btn yellow">BEM</a>
					</div>
				...
				<div class="widget__content table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<div class="dropdown">
							<td>
								<a href=" {{route('unduhDcfc.download', $RevisiKmh->id)}} " class="btn blue" >Lihat</a>
							</td>
						</div>
