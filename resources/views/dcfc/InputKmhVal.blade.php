@extends('dcfc.template')
	...
	<div class="col-md-12">
        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('proposaldcfc.store', $inputKmhVal->id) }}" method="POST" enctype="multipart/form-data">
                   {{ csrf_field() }}
                <div class="widget__content">
                    ...
                    <input type="text" name="title" class="stacked-input" value=" {{$inputKmhVal->title}} " id="input-1" placeholder="Judul Proposal">                   
                    ...
                    <label class="full-label">
                        <input type="file" name="file" id="file-att" value=" {{$inputKmhVal->file}} ">
