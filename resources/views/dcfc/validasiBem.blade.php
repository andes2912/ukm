        ...
        <div class="row">
			...
			<div class="tabs__content--2">
				...
				<div class="media message">
					...
					<div class="media-body">
						<h4 class="media-heading message__heading">{{$BemDcfcRev->title}}</h4> <span style="color:coral;"> <h5> {{ $BemDcfcRev->created_at->diffForHumans() }}</h5></span> <hr>
						<p class="message__msg"><span style="color:dodgerblue">Pengirim : BEM </span> | <span style="color:darkorange; font:bold;"> Tanggal :{{ $BemDcfcRev->created_at}} </span></p>
