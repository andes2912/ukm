        ...
        <div class="row">
					...
					<div class="media message">
						...
						<div class="message__controls--cont">
							<ul class="message__controls">
								...
								<li><a href=" {{ route('unduhBem.download', $BemDcfcAcc->id) }}" title="Download file {{ $BemDcfcAcc->title }}" onclick="return true;"><i class="pe-7f-back pe-rotate-180"></i> <span>Cetak</span></a></li>
			...
			<div class="tabs__content--2">
				...
				<div class="media message">
					...
					<div class="media-body">
						<h4 class="media-heading message__heading">{{$BemDcfcRev->title}} <span>{{ $BemDcfcRev->created_at->diffForHumans() }}</span></h4> <hr>
						<p class="message__msg"><span>Pengirim : BEM </span> | <span> Tanggal :{{ $BemDcfcRev->created_at}} </span></p>
						...
						<div class="message__controls--cont">
							<ul class="message__controls">
								...
								<li><a href="{{ route('unduhBem.download', $BemDcfcRev->id) }}" class="set_fav" onclick="return true;"><i class="pe-7f-back"></i> <span>Lihat</span></a></li>
